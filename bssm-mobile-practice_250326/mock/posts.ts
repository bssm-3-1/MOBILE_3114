...
const MOCK_POSTS: Post[] = [
    ...
    },
    {
        id: '8',
        userId: 'b7e9a012-33c4-4d5f-8a61-df2390e4c105',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post8/600/600' }],
        likes: 245,
        caption: '코딩하다가 찍은 야경 🌃 #개발자일상',
        timestamp: '2일 전',
        comments: [],
    },
    {
        id: '9',
        userId: 'c2d84f56-77a1-4b3e-b092-1e56780f3a29',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post9/600/600' }],
        likes: 1872,
        caption: '새 앨범 커버 디자인 작업 중 🎨',
        timestamp: '3일 전',
        comments: [],
    },
    {
        id: '10',
        userId: 'd901b3e7-cc20-4f6a-a514-8b34fd021c67',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post10/600/600' }],
        likes: 432,
        caption: '우리 냥이 낮잠 타임 😴',
        timestamp: '3일 전',
        comments: [],
    },
    {
        id: '11',
        userId: 'e148c590-55f2-4a7d-bc83-0d67921efa34',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post11/600/600' }],
        likes: 567,
        caption: '오늘의 브런치 메뉴 🥞',
        timestamp: '3일 전',
        comments: [],
    },
    {
        id: '12',
        userId: 'f36da027-89e4-4c10-9b52-7a4f305bc811',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post12/600/600' }],
        likes: 1340,
        caption: '해운대 일몰 진짜 미쳤다 🌅',
        timestamp: '4일 전',
        comments: [],
    },
    {
        id: '13',
        userId: '04a7e261-f0b3-4d98-8c15-6e23d9a07b52',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post13/600/600' }],
        likes: 2890,
        caption: '3주년 기념 일러스트 건졌다 🎉',
        timestamp: '4일 전',
        comments: [],
    },
    {
        id: '14',
        userId: 'b7e9a012-33c4-4d5f-8a61-df2390e4c105',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post14/600/600' }],
        likes: 178,
        caption: '새 키보드 도착 ⌨️ 타건감 최고',
        timestamp: '5일 전',
        comments: [],
    },
    {
        id: '15',
        userId: 'c2d84f56-77a1-4b3e-b092-1e56780f3a29',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post15/600/600' }],
        likes: 2201,
        caption: '라이브 끝! 오늘도 수고했다 🎤',
        timestamp: '5일 전',
        comments: [],
    },
    {
        id: '16',
        userId: 'd901b3e7-cc20-4f6a-a514-8b34fd021c67',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post16/600/600' }],
        likes: 654,
        caption: '창밖 구경하는 냥이 🪟',
        timestamp: '6일 전',
        comments: [],
    },
    {
        id: '17',
        userId: 'e148c590-55f2-4a7d-bc83-0d67921efa34',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post17/600/600' }],
        likes: 312,
        caption: '떡볶이는 진리다 🔥',
        timestamp: '6일 전',
        comments: [],
    },
    {
        id: '18',
        userId: 'f36da027-89e4-4c10-9b52-7a4f305bc811',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post18/600/600' }],
        likes: 987,
        caption: '감천문화마을 산책 🏘️',
        timestamp: '1주 전',
        comments: [],
    },
    {
        id: '19',
        userId: '04a7e261-f0b3-4d98-8c15-6e23d9a07b52',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post19/600/600' }],
        likes: 4102,
        caption: '총력전 1등 달성 🏆 #블루아카이브',
        timestamp: '1주 전',
        comments: [],
    },
    {
        id: '20',
        userId: 'b7e9a012-33c4-4d5f-8a61-df2390e4c105',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post20/600/600' }],
        likes: 89,
        caption: '카페에서 작업 중 ☕',
        timestamp: '1주 전',
        comments: [],
    },
    {
        id: '21',
        userId: 'c2d84f56-77a1-4b3e-b092-1e56780f3a29',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post21/600/600' }],
        likes: 1543,
        caption: '레코드판 컬렉션 추가 🎵',
        timestamp: '1주 전',
        comments: [],
    },
    {
        id: '22',
        userId: 'f36da027-89e4-4c10-9b52-7a4f305bc811',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post22/600/600' }],
        likes: 2456,
        caption: '광안리 야경은 언제 봐도 좋다 🌉',
        timestamp: '2주 전',
        comments: [],
    },
    {
        id: '23',
        userId: 'd901b3e7-cc20-4f6a-a514-8b34fd021c67',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post23/600/600' }],
        likes: 789,
        caption: '박스 안에 들어간 냥이 📦',
        timestamp: '2주 전',
        comments: [],
    },
    {
        id: '24',
        userId: 'e148c590-55f2-4a7d-bc83-0d67921efa34',
        images: [{ type: 'REMOTE', url: 'https://picsum.photos/seed/post24/600/600' }],
        likes: 445,
        caption: '삼겹살 파티 🥩🔥',
        timestamp: '2주 전',
        comments: [],
